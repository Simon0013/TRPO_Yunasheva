...
namespace WinFormsApp5
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "Система «Аттестация сотрудников предприятия»";
            ...
            this.labelCopyright.Text = "Авторские права: Юнашева Екатерина";
            ...
            this.labelCompanyName.Text = "Название организации: ГБПОУ РО \"РКСИ\"";
            ...
            this.textBoxDescription.Text = "Программа предназначена для автоматизации аттестации сотрудников предприятия, кот" +
    "орое периодически проводит аттестацию сотрудников на соответствие ими занимаемой" +
    " должности.";
            // 
            // okButton
            // 
